-- ============================================================
-- CARTEIRA GF — EXTRAS (idempotente; aplicar no SQL Editor)
-- ============================================================
...
-- pg_cron (opcional): descomente após habilitar a extensão no painel
-- CREATE EXTENSION IF NOT EXISTS pg_cron;
-- SELECT cron.schedule('gf-friday-release','0 3 * * 5',$$ SELECT public.release_pending_friday(); $$);
