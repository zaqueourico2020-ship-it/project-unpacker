...
ALTER TABLE public.partner_products ADD COLUMN IF NOT EXISTS brand text;
ALTER TABLE public.partner_products ADD COLUMN IF NOT EXISTS discount_price numeric(14,2);
ALTER TABLE public.partner_products ADD COLUMN IF NOT EXISTS images text[] NOT NULL DEFAULT '{}';
ALTER TABLE public.partner_products ADD COLUMN IF NOT EXISTS notes text;
...
ALTER TABLE public.products ADD COLUMN IF NOT EXISTS discount_price numeric(14,2);
